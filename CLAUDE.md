...
- **Projektlimit** (`Subscription.max_projects`, Default `DEFAULT_MAX_PROJECTS = 50`, pro User im Admin änderbar z.B. 100/200; auf der Konto-Seite angezeigt): Anzahl online speicherbarer Projekte. **Noch nicht durchgesetzt** — das Gate gehört in die kommende Online-Projektablage ("In der Cloud speichern"). Entschieden: Anzahl-Limit statt GB-Quote; dazu später ~200 MB Deckel pro Projekt und Archivierung nach 12 Monaten Inaktivität
