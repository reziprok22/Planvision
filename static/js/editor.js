...
function initializeEditor() {
    ...
    function saveEditorChanges() {
        ...
        // Auch die lokale data-Variable in main.js aktualisieren
        if (typeof data !== 'undefined') {
            data.predictions = JSON.parse(JSON.stringify(updatedResults));
        }
        ...
        // Anstatt die Seite neu zu laden, rufen wir die displayResults-Funktion
        // aus main.js auf, falls sie verfügbar ist
        if (typeof displayResults === 'function') {
            displayResults(window.data);
        } else {
            // Fallback: Visualisierung direkt aktualisieren
            updateVisualization();
        }
    }
